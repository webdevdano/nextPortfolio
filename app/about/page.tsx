    ...
    <div className="min-h-screen">
      <main className="max-w-5xl mx-auto px-6 pt-28 pb-16">
        <Hero
          ...
          bio="I build elegant, fast web experiences and design systems. I like turning complex problems into simple, polished interfaces."
          images={[
            { src: "/images/avatar.jpg", alt: "Portrait" },
            { src: "/images/projects/project-01/cover-01.jpg", alt: "Project" },
            { src: "/images/projects/project-01/cover-02.jpg", alt: "Project" },
          ]}
        />
